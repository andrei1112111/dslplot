...
from dslplot.Gramar.generated.GraphPlotVisitor import GraphPlotVisitor


HEADER = '''# THIS CODE WAS GENERATED BY DSLPLOT CODE GENERATION SYSTEM
# QUERY PARSING WAS PERFORMED USING ANTLR-4.13.2
# YOU CAN CHECK SOURCE CODE OF DSLPLOT ON https://github.com/andrei1112111/dslplot'''
...
def make_requirements(packages):
    imports = []
    for requirement, var in packages:
        imports.append(f"import {requirement} as {var}")

    return imports


def make_code(imports, body, header):
    return f"{header}\n{imports}\n\n{body}\nplt.tight_layout()\n"


class CodeGenerator(GraphPlotVisitor):
    def __init__(self, requirements=REQUIRED_PACKAGES):
        self.code = []
        self.imports = make_requirements(requirements)
        self.subplots = False
        self.subplot_rows = 1
        self.subplot_cols = 1
    ...
    def generate(self):
        ...
        return make_code(imports, body, HEADER)
